...
> **Archived source template:** This file is intentionally preserved verbatim apart from this notice. The completed Team 12 version is [README_BIOHACKATHON.md](../README_BIOHACKATHON.md); these placeholders are not active project documentation.
