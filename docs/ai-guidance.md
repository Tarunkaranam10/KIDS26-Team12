...
Start with the [technical README](../README.md) and the [executive plan](00_EXECUTIVE_PLAN.md), which give an AI assistant enough context for a first interaction with this repository.
