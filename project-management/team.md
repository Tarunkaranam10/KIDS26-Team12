...
- **Team lead(s):** Evan Savage (@esavage111) and Susanna Downing (co-leads) — [confirm GitHub handle for Susanna]
...
| Susanna Downing | [confirm handle] | Co-Lead / Technical Contributor, Data Explorer, Domain Expert | Domain expertise on HRD biology, data exploration, elastic-net model development | Evan Savage |
...
| Sanika Naik | [confirm handle — multiple candidates found] | Product Designer, Data Explorer, Domain Expert | Shiny app design, HRD domain input, data exploration | Tarun Venkat Sai Karanam |
| Talia Dalton | [confirm handle] | Data Explorer | Pediatric cancer dataset exploration and QC | Sai Thulabandu |
...
| Henry Dinh | [confirm handle — multiple candidates found] | Domain Expert | Domain expertise on pediatric high-grade glioma and cancer genomics | Eshwar P. Alicom |
