...
- **Tools and stack:** Python 3.10+ for acquisition, matching, QC, and reproducibility; R with `glmnet`, `data.table`, `jsonlite`, and `renv` for modeling; Bioconductor/minfi and conumee2 only for the gated intensity/CNV branch; Shiny for presentation; Git/GitHub for collaboration; Slack for team communication.
